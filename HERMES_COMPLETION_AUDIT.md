...
8. iOS and native macOS TestFlight builds are valid and internally assigned, but tester invitation acceptance and physical install/launch remain unobserved. Direct macOS release cannot complete without Developer ID Application signing/notarization credentials.
