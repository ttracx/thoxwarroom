...
class PlatformService {
  ...
  static Future<void> _feedbackFor(HapticType type) => switch (type) {
    HapticType.light => ThoxWarRoomHaptics.lightImpact(),
    HapticType.medium => ThoxWarRoomHaptics.mediumImpact(),
    HapticType.heavy => ThoxWarRoomHaptics.heavyImpact(),
    HapticType.selection => ThoxWarRoomHaptics.selectionClick(),
    HapticType.success => ThoxWarRoomHaptics.success(),
    HapticType.warning => ThoxWarRoomHaptics.warning(),
    HapticType.error => ThoxWarRoomHaptics.error(),
  };
