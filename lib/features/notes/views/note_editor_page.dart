...
/// Builds the rich-note editor theme from ThoxWarRoom's semantic color tokens.
///
...
class _NoteEditorPageState extends ConsumerState<NoteEditorPage> {
        ...
        children: [
          ...
          AdaptiveListTile(
            leading: Container(
              ...
              height: 44,
              decoration: BoxDecoration(
                color: thoxTheme.buttonPrimary.withValues(alpha: 0.1),
      ...
      final coordinator = NoteAudioUploadCoordinator(
        ...
        upload: (item, file) async {
                ...
                files
                    .where((candidate) {
                      ...
                      final marker = nested is Map
                          ? nested['thoxwarroom_upload_id']
                          : metadata?['thoxwarroom_upload_id'];
          ...
          return api.uploadFile(
            ...
            metadata: <String, dynamic>{'thoxwarroom_upload_id': item.id},
            cancelToken: cancelToken,
            authSnapshot: authSnapshot,
          );
        },
  ...
  Widget _buildNoteEditorLeading(
    ...
    return buildThoxWarRoomAdaptiveToolbarLeadingRow(
      children: [
        ...
        const SizedBox(width: kThoxWarRoomAdaptiveToolbarLeadingGap),
  ...
  Widget _buildNoteEditorTitlePill(
    ...
    final thoxTheme = context.thoxTheme;
    final l10n = AppLocalizations.of(context)!;
    final titleTextStyle = thoxAdaptiveToolbarPillTextStyle(context);
    final controlExtent = thoxScaledControlExtent(context);
                              ...
                              child: MiddleEllipsisText(
                                ...
                                style: titleTextStyle.copyWith(
                                  color: _titleController.text.isEmpty
                                      ? thoxTheme.textSecondary.withValues(
                                          alpha: 0.6,
                                        )
                                      : thoxTheme.textPrimary,
                                ),
                              ),
                            ),
                        ],
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: AppTypography.tiny.copyWith(
          color: context.thoxTheme.textSecondary.withValues(alpha: 0.5),
        ),
      ),
    );
  }
  ...
  Widget _buildMetadataChip(
    ...
    final secondaryColor = context.thoxTheme.textSecondary;
  ...
  Widget _buildEditor(BuildContext context) {
    ...
    final appBarHeight = thoxAdaptiveToolbarHeightOf(context) + 40;
