...
class BrandService {
  ...
  /// Brand colors - these should be accessed through context.thoxTheme in UI components
  ...
  static Widget createBrandAvatar({
    ...
    final iColor =
        iconColor ??
        (context?.thoxTheme.textInverse ?? tokens.neutralTone00);
  ...
  static Widget createBrandEmptyStateIcon({
    ...
    final tokens = _resolveTokens(context);
    final iconColor =
        color ?? (context?.thoxTheme.iconSecondary ?? tokens.neutralTone80);
    ...
    return Container(
      ...
      height: size,
      decoration: BoxDecoration(
        color: context?.thoxTheme.surfaceBackground ?? tokens.neutralTone10,
        borderRadius: BorderRadius.circular(size / 2),
        border: Border.all(
          color: context?.thoxTheme.dividerColor ?? tokens.neutralTone40,
          width: 2,
        ),
      ),
  ...
  static String get brandName => 'ThoxWarRoom';
  ...
  static PreferredSizeWidget createBrandAppBar({
    ...
    return AppBar(
      title: Text(
        title,
        style: context != null
            ? context.thoxTheme.headingSmall?.copyWith(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: context != null
            ? ThoxWarRoomShadows.glow(context)
            : ThoxWarRoomShadows.glowWithTokens(tokens),
      ),
      child: Icon(
        primaryIcon,
        size: size * 0.5,
