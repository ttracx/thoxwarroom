...
@immutable
class ThoxWarRoomThemeExtension extends ThemeExtension<ThoxWarRoomThemeExtension> {
  const ThoxWarRoomThemeExtension._({
  ...
  factory ThoxWarRoomThemeExtension.create({
    ...
    return ThoxWarRoomThemeExtension._(
      tokens: tokens,
  ...
  @override
  ThoxWarRoomThemeExtension copyWith({
  ...
  @override
  ThoxWarRoomThemeExtension lerp(
    covariant ThemeExtension<ThoxWarRoomThemeExtension>? other,
    double t,
  ) {
    if (other is! ThoxWarRoomThemeExtension) return this;
...
/// Extension method to easily access ThoxWarRoom theme from BuildContext
extension ThoxWarRoomThemeContext on BuildContext {
  ThoxWarRoomThemeExtension get thoxTheme {
    final theme = Theme.of(this);
    final extension = theme.extension<ThoxWarRoomThemeExtension>();
    ...
    return ThoxWarRoomThemeExtension.create(
      theme: palette,
      tokens: tokens,
...
extension ThoxWarRoomPlatformContext on BuildContext {
...
extension ThoxWarRoomMotionContext on BuildContext {
...
extension ThoxWarRoomColorTokensContext on BuildContext {
...
extension ThoxWarRoomPaletteContext on BuildContext {
