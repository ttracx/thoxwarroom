...
| War Room Read-only Dashboard | See fleet, mesh, routes, and alerts in one place | Operator | 9 | 8 | 7 | 9 | 8.3 | War Room adapters, cache, status UI | Real endpoints, stale/error states, provenance and timestamps | Inconsistent device APIs | In progress: typed synthetic-fixture Mesh adapter; no UI/live evidence |
