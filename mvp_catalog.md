...
|---|---|---|---:|---:|---:|---:|---:|---|---|---|---|
| Secure Workspace Foundation | Safely connect Apple apps to local/private THOX services | Admin/operator | 10 | 8 | 8 | 10 | 9.0 | Identity, Keychain, transport, trust, audit | Add/test/remove a private endpoint; secrets never logged; boundary visible | TLS and auth contract drift | In progress: core + onboarding complete; Keychain/transport pending |
