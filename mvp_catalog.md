...
|---|---|---|---:|---:|---:|---:|---:|---|---|---|---|
| Secure Workspace Foundation | Safely connect Apple apps to local/private THOX services | Admin/operator | 10 | 8 | 8 | 10 | 9.0 | Identity, Keychain, transport, trust, audit | Add/test/remove a private endpoint; secrets never logged; boundary visible | TLS and auth contract drift | In progress: primitives complete; credential/provider wiring pending |
...
| Hermes Review Console | Observe sessions/jobs and approve or deny tools | Operator/approver | 10 | 7 | 6 | 10 | 8.3 | Hermes adapter, approval UI, audit | Live session stream; explicit approval; durable audit event | Unsafe action execution | In progress: buffered contract client only |
